...
//    moza::motorMoveTo((HWND)widget.winId(),steeringWheelAngle,speed, err);
//    return;
    ...
    while (1)
    {
        ...
        {
            //            std::cout<<"d->fSteeringWheelAngle"<< d->fSteeringWheelAngle<<std::endl;
            if (flag == false)
            {
            ...
            //            std::cout<<"delta_theta:" <<delta_theta <<"current_spd:" <<current_spd;
